...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{asset('v1/themes/sneat-dashboard/assets/vendor/css/pages/page-misc.css')}}" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <a href="javascript:history.go(-1)" class="btn btn-primary">Back to home</a>
        <div class="mt-3">
          <img
            src="{{asset('v1/themes/sneat-dashboard/assets/img/illustrations/page-misc-error-light.png')}}"
