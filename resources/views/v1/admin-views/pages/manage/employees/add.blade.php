...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @include('v1.admin-views.partials.content-header',['pageParent' => 'Quản lý Nhân viên', 'pageName' => 'Thêm mới Nhân viên'])
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select" name="role_id" required>
                                    ...
                                    <option value="3">Người soạn nội dung</option>
                                    <option value="4">Nhà thiết kế</option>
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
