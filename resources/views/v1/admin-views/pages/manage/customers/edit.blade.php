...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @include('v1.admin-views.partials.content-header',['pageParent' => 'Quản lý Khách hàng', 'pageName' => 'Sửa Khách hàng'])
        ...
        <div class="col-lg">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between my-2">
                    <div class="p-2">
                        <h5 class="card-title mb-0">Sửa Khách hàng</h5>
                    </div>
                    <!-- <div class="pt-md-0">
                ...
                <div class="card-body">
                    <form action="{{route('customers.update',['id' => $customer->id ])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="img-upload-container">
                            <img class="avatar1 img-upload-holder" src="{{$customer->avatar_path}}">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="text" name="name" value="{{$customer->display_name}}" class="form-control" placeholder="Nhập hoặc nói Họ và tên" aria-describedby="text-to-speech-addon" required>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group ">
                                    <input type="date" name="dob" value="{{$customer->dob}}" class="form-control" placeholder="Nhập hoặc nói tên sản phẩm" aria-describedby="text-to-speech-addon" required>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="number" name="phone" value="{{$customer->phone}}" class="form-control" placeholder="Nhập hoặc nói số điện thoại" aria-describedby="text-to-speech-addon" required>
                                    <span class="input-group-text" id="text-to-speech-addon">
                                        <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                                    </span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="email" name="email" value="{{$customer->email}}" class="form-control" placeholder="Nhập hoặc nói email" aria-describedby="text-to-speech-addon" required disabled>
                                    <span class="input-group-text" id="text-to-speech-addon">
                                        <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                                    </span>
                                </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="form-control" name="password" value="{{$customer->password}}" id="basic-default-password32" placeholder="············" aria-describedby="basic-default-password" required disabled>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select" name="role_id" required>
                                    <option value="6" {{($customer->role_id == 6) ? 'selected' : ''}}>Khách hàng thường</option>
                                    <option value="5" {{($customer->role_id == 5) ? 'selected' : ''}}>Khách hàng VIP</option>
                        ...
                        <!-- <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="number" min="0" name="salary_per_month" value="{{$customer->salary}}" class="form-control" placeholder="Nhập hoặc nói lương tháng" aria-describedby="text-to-speech-addon" required>
                                    <span class="input-group-text" id="text-to-speech-addon">
                                        <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                                    </span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="">
                                    ...
                                    @if (isset($customer->id_card_front))
                                    <img class="avatar2 my-3 img-custom" width="250" height="200" src="{{ $customer->id_card_front }}">
                                    @else
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="">
                                    ...
                                    @if (isset($customer->id_card_back))
                                    <img class="avatar3 my-3 img-custom" width="250" height="200" src="{{ $customer->id_card_back }}">
                                    @else
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="input-group input-group-merge speech-to-text">
                                <textarea class="form-control" name="address" placeholder="Điền hoặc nói địa chỉ" rows="6">{{$customer->address}}</textarea>
                        ...
                        <!-- <div class="mb-3">
                            ...
                            <textarea class="form-control tinymce-editor" name="description" id="exampleFormControlTextarea1" rows="25">{{$customer->description}}</textarea>
                        </div> -->
