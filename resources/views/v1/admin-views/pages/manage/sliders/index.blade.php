...
<title>Quản lý Slider đầu trang</title>
@endsection
...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  @include('v1.admin-views.partials.content-header',['pageParent' => 'Quản lý Slider đầu trang', 'pageName' => 'Tất cả danh mục'])
    ...
    <div class="col-lg">
      <div class="card mb-4">
        <div class="card-header d-flex justify-content-between my-2">
          <div class="p-2">
            <h5 class="card-title mb-0">Danh sách Slider đầu trang</h5>
          </div>
          <div class="pt-md-0">
            <a href="{{ route('sliders.create') }}" class="dt-button create-new btn btn-success" type="button">
              <span>
                <i class="bx bx-plus me-sm-2"></i>
                <span class="d-none d-sm-inline-block">Thêm mới Slider</span>
              </span>
            </a>
          </div>
        </div>
              ...
              <tbody class="table-border-bottom-0">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <img class="img-custom" width="150" height="100" src="{{ $slider->avatar_path }}">
                    @else
                  ...
                  <td>
                    ...
                    <a type="button" href="" class="btn btn-danger mx-1 action-delete" data-url="{{route('sliders.delete', ['id' => $slider->id])}}">
                      <span>
