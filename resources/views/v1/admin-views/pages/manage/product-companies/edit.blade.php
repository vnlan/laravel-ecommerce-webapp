...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @include('v1.admin-views.partials.content-header',['pageParent' => 'Quản lý Hãng sản xuất', 'pageName' => 'Sửa Hãng'])
        ...
        <div class="col-lg">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between my-2">
                    <div class="p-2">
                        <h5 class="card-title mb-0">Sửa hãng sản xuất</h5>
                    </div>
                    <!-- <div class="pt-md-0">
                ...
                <div class="card-body">
                    <form action="{{ route('product-companies.update',['id' => $productCompany->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Tên hãng sản xuất:</label>
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="text" name="company_name" value="{{$productCompany->company_name}}" class="form-control" placeholder="Nhập hoặc nói tên hãng" aria-describedby="text-to-speech-addon" required>
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Tên viết tắt:</label>
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="text" name="company_short_name" value="{{$productCompany->company_short_name}}" class="form-control" placeholder="Nhập hoặc nói tên viết tắt" aria-describedby="text-to-speech-addon" required>
                                    <span class="input-group-text" id="text-to-speech-addon">
                                        <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                                    </span>
                                </div>
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-company">Ảnh đại diện hãng:</label>
                            <div class="col-sm-10">
                                ...
                                @if (isset($productCompany->avatar_path))
                                    <img class="avatar1 my-3 img-custom" width="250" height="200" src="{{ $productCompany->avatar_path }}">
                                @else
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge speech-to-text">
                                    <textarea class="form-control" name="description" placeholder="Điền hoặc nói mô tả chi tiết" rows="4">{{$productCompany->description}}</textarea>
