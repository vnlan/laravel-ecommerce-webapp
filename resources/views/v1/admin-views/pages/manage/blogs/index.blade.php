...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  @include('v1.admin-views.partials.content-header',['pageParent' => 'Quản lý Blogs', 'pageName' => 'Tất cả Blogs'])
    ...
    <div class="col-lg">
      <div class="card mb-4">
        <div class="card-header d-flex justify-content-between my-2">
          <div class="p-2">
            <h5 class="card-title mb-0">Danh sách blogs </h5>
          </div>
          <div class="pt-md-0">
            <a href="{{ route('blogs.create') }}" class="dt-button create-new btn btn-success" type="button">
              <span>
              ...
              <tbody class="table-border-bottom-0">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <img class="img-custom" width="150" height="100" src="{{ $blog->avatar_path }}">
                    @else
                  ...
                  <td>{{$blog->employee->email}}</td>

                  <td>
                    <a type="button" href="{{ route('blogs.edit', ['id' => $blog->id]) }}" class="btn btn-primary">
                      <span>
                    ...
                    <a type="button" href="" class="btn btn-danger mx-1 action-delete" data-url="{{route('blogs.delete', ['id' => $blog->id])}}">
                      <span>
