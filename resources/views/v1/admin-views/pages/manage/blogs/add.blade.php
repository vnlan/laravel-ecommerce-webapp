...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @include('v1.admin-views.partials.content-header',['pageParent' => 'Quản lý Blogs', 'pageName' => 'Thêm mới Blogs'])
        ...
        <div class="col-lg">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between my-2">
                    <div class="p-2">
                        <h5 class="card-title mb-0">Thêm mới Blogs</h5>
                    </div>
                    <!-- <div class="pt-md-0">
                ...
                <div class="card-body">
                    <form action="{{ route('blogs.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="text" name="title" class="form-control" placeholder="Nhập hoặc nói tiêu đề Blogs" aria-describedby="text-to-speech-addon" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-select" name="blog_category" required>
                                    <option value="Chưa đặt tên">Chưa đặt tên</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge speech-to-text">
                                    <textarea class="form-control" name="short_description" placeholder="Điền hoặc nói mô tả" rows="4"></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control tinymce-editor" name="content" id="exampleFormControlTextarea1" rows="25"></textarea>
                        </div>
