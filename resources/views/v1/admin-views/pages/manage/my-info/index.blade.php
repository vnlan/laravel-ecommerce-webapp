...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @include('v1.admin-views.partials.content-header',['pageParent' => 'Trang chủ', 'pageName' => 'Thông tin cá nhân'])
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="text" name="name" value="{{Auth::user()->display_name}}" class="form-control" placeholder="Nhập hoặc nói Họ và tên" aria-describedby="text-to-speech-addon" required>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group ">
                                    <input type="date" name="dob" value="{{Auth::user()->dob}}" class="form-control" placeholder="Nhập hoặc nói tên sản phẩm" aria-describedby="text-to-speech-addon" required>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="number" name="phone" value="{{Auth::user()->phone}}" class="form-control" placeholder="Nhập hoặc nói số điện thoại" aria-describedby="text-to-speech-addon" required>
                                    <span class="input-group-text" id="text-to-speech-addon">
                                        <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                                    </span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="email" name="email" value="{{Auth::user()->email}}" class="form-control" placeholder="Nhập hoặc nói email" aria-describedby="text-to-speech-addon" required disabled>
                                    <span class="input-group-text" id="text-to-speech-addon">
                                        <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                                    </span>
                                </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="form-control" name="password" value="{{Auth::user()->password}}" id="basic-default-password32" placeholder="············" aria-describedby="basic-default-password" required disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group input-group-merge speech-to-text">
                                    <input type="number" min="0" name="salary_per_month" value="{{Auth::user()->salary}}" class="form-control" placeholder="Nhập hoặc nói lương tháng" aria-describedby="text-to-speech-addon" required>
                                    <span class="input-group-text" id="text-to-speech-addon">
                                        <i class="bx bx-microphone cursor-pointer text-to-speech-toggle"></i>
                                    </span>
                                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="input-group input-group-merge speech-to-text">
                                <textarea class="form-control" name="address" placeholder="Điền hoặc nói địa chỉ" rows="6">{{Auth::user()->address}}</textarea>
