...
<head>
    ...
    <title>Đăng nhập SMG Music Control</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{asset('v1/themes/sneat-dashboard/assets/vendor/css/pages/page-auth.css')}}" />
    <!-- Helpers -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">TinaWatch</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Chào mừng đến với trang quản trị TinaWatch! 👋</h4>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{route('admin.auth.login')}}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="Nhập email đăng nhập" autofocus />
                            </div>
